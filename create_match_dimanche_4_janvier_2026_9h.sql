-- Script pour créer un match validé le dimanche 4 janvier 2026 de 9h00 à 10h30
...
BEGIN
  ...
  -- 4. Créer le match pour dimanche 4 janvier 2026 de 9h00 à 10h30
  match_date := '2026-01-04 09:00:00'::timestamptz;
  match_end := match_date + INTERVAL '1 hour 30 minutes';
  
  RAISE NOTICE '';
  RAISE NOTICE '📋 Création du match validé pour le dimanche 4 janvier 2026 de 9h00 à 10h30...';
  ...
  RAISE NOTICE '   - Date: dimanche 4 janvier 2026 de 9h00 à 10h30';
...
WHERE m.id = (
  ...
  WHERE m2.group_id = (SELECT id FROM groups WHERE name ILIKE '%50+%' OR name ILIKE '%test%50%' OR name ILIKE '%50+ membres%' LIMIT 1)
    AND ts2.starts_at = '2026-01-04 09:00:00'::timestamptz
