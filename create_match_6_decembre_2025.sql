-- Script pour créer un match validé le samedi 6 décembre 2025 à 18h
...
BEGIN
  ...
  -- Samedi 6 décembre 2025 à 18h00
  -- ==========================================
  RAISE NOTICE '';
  RAISE NOTICE '📋 Création d''un match validé (samedi 6 décembre 2025 à 18h00)...';
  
  -- Date : samedi 6 décembre 2025 à 18h00
  match_date := '2025-12-06'::date + TIME '18:00:00';
  ...
  IF v_time_slot_id IS NULL THEN
    ...
    EXCEPTION WHEN unique_violation THEN
      ...
      match_date := '2025-12-06'::date + TIME '19:00:00';
      match_end := match_date + INTERVAL '1 hour 30 minutes';
  ...
  RAISE NOTICE '   - Date: Samedi 6 décembre 2025 à 18h00';
