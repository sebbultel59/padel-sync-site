-- Script pour créer un match le vendredi 26 janvier 2025 de 9h00 à 10h30
...
BEGIN
  ...
  -- 4. Créer le match pour vendredi 26 janvier 2025 de 9h00 à 10h30
  match_date := '2025-01-26 09:00:00'::timestamptz;
  match_end := match_date + INTERVAL '1 hour 30 minutes';
  
  RAISE NOTICE '';
  RAISE NOTICE '📋 Création du match pour le vendredi 26 janvier 2025 de 9h00 à 10h30...';
  ...
  IF v_match_id IS NULL THEN
    -- Créer le match avec status='pending'
  ...
  -- Créer 4 RSVPs acceptés (sebbultel + 3 autres joueurs)
  ...
  RAISE NOTICE '✅ RSVPs créés pour les 4 joueurs (sebbultel + 3 autres avec téléphone)';
  RAISE NOTICE '';
  RAISE NOTICE '✅ Match créé avec succès!';
  RAISE NOTICE '   - Match ID: %', v_match_id;
  RAISE NOTICE '   - Date: vendredi 26 janvier 2025 de 9h00 à 10h30';
  RAISE NOTICE '   - Status: pending';
  RAISE NOTICE '   - Joueurs: sebbultel59@gmail.com + 3 autres avec téléphone';
...
WHERE m.id = (
  ...
  WHERE m2.group_id = (SELECT id FROM groups WHERE name ILIKE '%50+%' OR name ILIKE '%test%50%' OR name ILIKE '%50+ membres%' LIMIT 1)
    AND ts2.starts_at = '2025-01-26 09:00:00'::timestamptz
